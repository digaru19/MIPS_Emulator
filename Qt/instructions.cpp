...
void _div::execute() {
    ...
    RegisterFile.write_reg( divident / divisor , 33);   //  LO is 33
    RegisterFile.write_reg( divident % divisor , 32);   // HI is 32
}
...
void mult::execute() {
    ...
    RegisterFile.write_reg(multiplicand * multiplier , 33);
}
